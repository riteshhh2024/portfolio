...
export const siteConfig = {
  ...
  description:
    'Software Engineer specializing in LLM-powered agentic systems, multi-agent orchestration, RAG pipelines, and backend platforms with Python and .NET',
  ...
  author: {
    ...
    twitter: '',
    github: 'riteshhh2024',
    linkedin: 'ritesh-prajapati-9bbb78348',
